      ...
      <div className="mt-16 bg-gray-50">
        ...
        <section className="mt-14">
          ...
          <div className="mt-2 flex flex-col justify-between md:flex-row gap-5 items-center max-w-6xl m-auto py-2 px-4">
            <div className="w-full flex flex-col shadow-sm shadow-slate-300 p-5 md:w-2/6">
            ...
            <div className="w-full flex flex-col shadow-sm shadow-slate-300 p-5 py-8 md:w-2/6">
            ...
            <div className="w-full flex flex-col shadow-sm  shadow-slate-300 p-5 py-14 md:w-2/6">
              <h3 className="w-full ">
