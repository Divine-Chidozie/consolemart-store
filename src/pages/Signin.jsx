    ...
    <section className="w-full md:w-2/5 my-24 mx-auto p-10 text-center">
      ...
      >
        <input
          ...
          className="border-2 border-gray-200 py-2 pl-2 w-3/5 text-lg text-gray-700 outline-none mb-1"
        />
        {emailError && (
        ...
        <input
          ...
          className="border-2 border-gray-200 mb-1 py-2 pl-2 w-3/5 text-lg text-gray-700 outline-none"
        />
        {passwordError && (
